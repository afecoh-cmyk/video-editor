...
7. Hosszú nyomás X módban vagy a `Muff (N)` gomb → közös típus + DM adatlap.
   - Az adatlapon a **Kiválasztva** sor mindig mutatja a típust + DM-et (muffénál is, pl. Muffe · DM 315).
   - A DM mezőre koppintva ugyanabban a lapon nyílik a görgethető méretmenü (DM 90–710); a választás után a szám a mezőben és a Kiválasztva sorban marad.
